...
public class PosTest {
    ...
    @Test
    public void testShouldSupportDiscountWhenHavingTwoFavourableItems() throws EmptyShoppingCartException {
        // given
        ShoppingChart shoppingChart = new ShoppingChart();
        shoppingChart.add(new Item("ITEM000000", "雪碧", "瓶", 2.00, 0.8));
        shoppingChart.add(new Item("TTEM000001","可口可乐","瓶",3.00,0.7));
        ...
        String expectedShoppingList =
                "***商店购物清单***\n"
                        + "名称：雪碧，数量：1瓶，单价：2.00(元)，小计：1.60(元)\n"
                        +"名称：可口可乐，数量：1瓶，单价：3.00(元)，小计：2.10(元)\n"
                        + "----------------------\n"
                        + "总计：3.70(元)\n"
                        + "节省：1.30(元)\n"
                        + "**********************\n";
    ...
    @Test
    public void DiscountCorrectWhenOneFavourableItemWhileOneNot() throws EmptyShoppingCartException {
        // given
        ShoppingChart shoppingChart = new ShoppingChart();
        shoppingChart.add(new Item("ITEM000000", "雪碧", "瓶", 2.00, 0.8));
        shoppingChart.add(new Item("TTEM000001","可口可乐","瓶",3.00));
